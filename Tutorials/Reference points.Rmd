...
```{r recruitment stochasticity, echo=TRUE, warning=FALSE, message = FALSE,fig.width=10,fig.height=5}
Nyears <- 40
seed <- 2025
rho <- 0.8
sigma_r <- 0.5
